...
#
#   NEW: call the function once, comment it out, then call it agian with different values
#
###############################################################################

def turtle_func(color,thickness):
    window = rg.TurtleWindow()
    turtle_one = rg.SimpleTurtle()
    turtle_one.pen = rg.Pen('green',thickness)
    turtle_two = rg.SimpleTurtle()
    turtle_two.pen = rg.Pen(color,5)
    turtle_one.forward(100)
    turtle_two.backward(100)
